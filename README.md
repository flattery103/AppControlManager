# AppControl Manager 1.0.0-rc.5

## 1.0.0 Release Candidate 5

Version 1.0.0-rc.5 synchronizes heartbeat background-work states with the Windows agent and simplifies successful approval messages. It retains RC4's exact-hash fallback for signed components without version identity.
...
Configure these GitHub Actions secrets in the `release` environment before creating a signed release tag such as `v1.0.0-rc.5`:
