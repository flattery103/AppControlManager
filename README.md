# AppControl Manager 1.0.0-rc.6

## 1.0.0 Release Candidate 6

Version 1.0.0-rc.6 recovers superseded background rules whose prior attempt count made them unclaimable, allowing their dependent approval bundles to finish. It retains RC5's heartbeat status synchronization and simplified approval display.
...
Configure these GitHub Actions secrets in the `release` environment before creating a signed release tag such as `v1.0.0-rc.6`:
